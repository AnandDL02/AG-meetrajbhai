...
import img11 from "../image/m11.jpg";
  ...
  const values = [
    {
      ...
      title: "Quality First",
      description:
        "We never compromise on quality. Every product undergoes rigorous testing and quality checks.",
    },
    {
      icon: <Heart className="h-10 w-10 text-green-600" />,
      title: "Trust & Transparency",
      description:
        "Building long-term relationships through honest communication and transparent dealing.",
    },
    {
      icon: <Target className="h-10 w-10 text-green-600" />,
      title: "On-Time Delivery",
      description:
        "Committed to meeting deadlines and ensuring timely shipment to all our global clients.",
    },
    {
      ...
      <section className="relative py-24 bg-gradient-to-br from-green-900 via-green-800 to-green-700 text-white overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center animate-fade-in">
          ...
          <p className="text-xl md:text-2xl opacity-90 max-w-3xl mx-auto">
            Your trusted partner for premium quality agro exports from the heart
            of Gujarat, India
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4 leading-relaxed">
                Founded with a vision to bridge the gap between Gujarat's
                agricultural excellence and global markets, Shree Hari
                International has emerged as a trusted name in agro exports.
              </p>
              <p className="text-gray-600 mb-4 leading-relaxed">
                Based in Gujarat, we leverage our strategic location and
                deep-rooted connections with local farmers to source the finest
                quality products.
              </p>
              <p className="text-gray-600 leading-relaxed">
                Our commitment to quality, transparency, and customer
                satisfaction has enabled us to build lasting partnerships with
                importers across Middle East, Africa, Europe, and Vietnam.
              </p>
            </div>
            <div className="bg-gradient-to-br from-green-100 to-green-200 rounded-2xl p-10 shadow-xl">
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Our Mission</h3>
              <p className="text-gray-600 mb-6">
                To deliver premium quality agro products while building
                sustainable partnerships that benefit farmers, traders, and
                consumers worldwide.
              </p>
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Our Vision</h3>
              <p className="text-gray-600">
                To become the most trusted and preferred partner for agro exports
                from India, recognized globally for quality, reliability, and
                innovation.
              </p>
            </div>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-6 text-center">
          <div className="bg-white rounded-2xl shadow-2xl p-12 max-w-3xl mx-auto">
            <div style={{ backgroundImage: `url(${img11})` }} className="w-40 h-40 mx-auto mb-6 rounded-full  border-4 border-green-600 shadow-lg  bg-cover">
              
            </div>
            <h2 className="text-3xl font-bold text-gray-800 mb-2">
              Meet Nileshbhai Piprotar
            </h2>
            <p className="text-green-600 font-semibold text-lg mb-6">
              Founder & CEO
            </p>
            <p className="text-gray-600 text-lg leading-relaxed mb-6 italic">
              "With years of experience in agriculture and international trade, I
              founded Shree Hari International with a simple yet powerful vision
              - to showcase the excellence of Gujarat's agricultural products to
              the world."
            </p>
            <p className="text-gray-600 text-lg leading-relaxed">
              "Our success lies in our commitment to quality, our relationships
              with farmers, and our dedication to serving our international
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
            {team.map((member, i) => (
              ...
              >
                {/* Profile Image */}
                <div
                  className="w-32 h-32 mx-auto rounded-full border-4 border-green-500 shadow-lg mb-6 bg-cover bg-top"
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-10 max-w-4xl mx-auto">
            {foodCertifications.map((cert, i) => (
              <div
                key={i}
                className="flex flex-col items-center bg-white p-6 rounded-xl shadow hover:shadow-xl transition transform hover:-translate-y-2"
              >
                <img
                  src={cert.image}
                  alt={cert.name}
