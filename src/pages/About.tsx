    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center bg-white rounded-2xl shadow-xl p-12">
            <div
              className="w-40 h-40 bg-cover mx-auto mb-6 rounded-full"
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 mb-12">Certified for quality and compliance</p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-gray-800 mb-4">Food Safety Certifications</h2>
               <p className="text-xl text-gray-600 mb-12">CERTIFICATED</p>

          <div className="grid grid-cols-2 md:grid-cols-3 gap-10 max-w-4xl mx-auto mt-12">
            {foodCertifications.map((cert, index) => (
              <div key={index} className="flex flex-col items-center space-y-3 bg-white p-6 rounded-xl shadow hover:shadow-lg transition">
                <img src={cert.image} alt={cert.name} className="h-20 object-contain" />
